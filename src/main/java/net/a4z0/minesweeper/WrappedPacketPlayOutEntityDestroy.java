...
public class WrappedPacketPlayOutEntityDestroy extends WrappedPacket {
    ...
    */
    ...
    public WrappedPacketPlayOutEntityDestroy(int... IDs) {
        try {
            this.NMSObject = WrappedClass.PACKET_PLAY_OUT_ENTITY_DESTROY.getNMSClass().getConstructor(int[].class).newInstance(IDs);
